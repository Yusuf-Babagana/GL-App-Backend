...
from .views import (
    ...
    PromotedPostCreateView, ActivePromotedPostListView, PromotedPostPricingView,
)
...
urlpatterns = [
    ...
    path('seller/products/<int:pk>/', ProductUpdateView.as_view(), name='seller-product-detail'),
