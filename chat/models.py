...
class Conversation(models.Model):
    ...
    # Link to a product so the seller knows the context of the chat
    product_context = models.ForeignKey('market.Product', on_delete=models.SET_NULL, null=True, blank=True)
